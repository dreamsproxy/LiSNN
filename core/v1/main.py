...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Train the LiSNN v1 language timecode baseline and reconstruct the "
    ...
    parser.add_argument("--checkpoint", default="language_timecode_model_v1.npz")
    parser.add_argument("--output", default="language_timecode_recall_v1.txt")
    return parser
